...
pub fn create_agent(
    ...
    info!(
        "cmd::create_agent(node_id={}, workflow_path={})",
...
pub fn transition_agent(
    ...
    runtime: State<'_, AgentRuntime>,
) -> Result<AgentState, ReasonanceError> {
    info!(
        "cmd::transition_agent(agent_id={}, new_state={:?})",
        agent_id, new_state
    );
...
#[tauri::command]
pub fn set_agent_pty(
    agent_id: String,
    pty_id: String,
    runtime: State<'_, AgentRuntime>,
) -> Result<(), ReasonanceError> {
    info!(
        "cmd::set_agent_pty(agent_id={}, pty_id={})",
        agent_id, pty_id
    );
...
pub fn set_agent_error(
    ...
    error!(
        "cmd::set_agent_error(agent_id={}, message={})",
        agent_id, message
    );
...
pub fn get_agent_memory(
    ...
    workflow_path: String,
    persist: String,
) -> Result<Vec<MemoryEntry>, ReasonanceError> {
    info!(
        "cmd::get_agent_memory(node_id={}, persist={})",
        node_id, persist
    );
