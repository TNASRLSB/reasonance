...
#[tauri::command]
pub fn transition_agent(agent_id: String, new_state: AgentState, runtime: State<'_, AgentRuntime>) -> Result<AgentState, ReasonanceError> {
...
#[tauri::command]
pub fn set_agent_pty(agent_id: String, pty_id: String, runtime: State<'_, AgentRuntime>) -> Result<(), ReasonanceError> {
    info!("cmd::set_agent_pty(agent_id={}, pty_id={})", agent_id, pty_id);
    runtime.set_pty(&agent_id, &pty_id)
}

#[tauri::command]
pub fn set_agent_error(agent_id: String, message: String, runtime: State<'_, AgentRuntime>) -> Result<(), ReasonanceError> {
...
#[tauri::command]
pub fn remove_agent(agent_id: String, runtime: State<'_, AgentRuntime>) -> Result<(), ReasonanceError> {
...
#[tauri::command]
pub fn get_agent_memory(node_id: String, workflow_path: String, persist: String) -> Result<Vec<MemoryEntry>, ReasonanceError> {
